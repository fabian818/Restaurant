...
class WaitersControllerTest < ActionController::TestCase
  ...
  test "should create waiter" do
    assert_difference('Waiter.count') do
      post :create, waiter: { clients: @waiter.clients, person_id: @waiter.person_id, salary: @waiter.salary, state: @waiter.state }
    end
  ...
  test "should update waiter" do
    patch :update, id: @waiter, waiter: { clients: @waiter.clients, person_id: @waiter.person_id, salary: @waiter.salary, state: @waiter.state }
    assert_redirected_to waiter_path(assigns(:waiter))
  end
